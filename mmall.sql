...
/*!40000 ALTER TABLE `product`
    DISABLE KEYS */;
INSERT INTO `product`
VALUES (733, '香奈儿', '订单', 152, 11912919, 548, 654, 655, 'baby_1.jpg'),
       (734, '洗面奶', '', 152, 11912919, 548, 654, 655, 'baby_2.jpg'),
       (735, '水啫喱水', '', 152, 11912919, 548, 654, 655, 'baby_3.jpg'),
       (736, '香水', '', 152, 11912919, 548, 654, 655, 'baby_4.jpg'),
       (737, '香水', '', 152, 11912919, 548, 654, 655, 'baby_5.jpg'),
       (738, '润肤露', '', 45, 11912919, 548, 654, 655, 'baby_6.jpg'),
       (739, '洁面装', '', 156, 11912919, 548, 654, 655, 'bk_2.jpg'),
       (740, '电饭锅', '', 158, 11912919, 628, 656, 659, 'bk_1.jpg'),
       (741, '婴儿喂奶装', '', 569, 11912919, 632, 637, 653, 'bk_3.jpg'),
       (742, '坚果套餐', '', 158, 11912919, 660, 661, 662, 'bk_4.jpg'),
       (743, '超甜蜜崭', '', 589, 11912919, 660, 661, 663, 'bk_5.jpg'),
       (744, '华为2566', '', 589, 11912919, 670, 671, 672, 'de1.jpg'),
       (745, '荣耀3C', '', 589, 11912919, 670, 671, 672, 'de2.jpg'),
       (746, '小米手环', '', 963, 11912919, 670, 674, 675, 'de3.jpg'),
       (747, '华为2265', '', 896, 11912919, 670, 671, 673, 'de4.jpg'),
       (748, '越南坚果', '', 520, 11912919, 660, 661, 662, 'de5.jpg'),
       (749, '日本进口马桶', '', 5866, 11912919, 628, 657, 0, 'food_1.jpg'),
       (750, '联想Y系列', '', 569, 11912919, 670, 690, 691, 'food_2.jpg'),
       (751, '脑白金1号', '', 589, 11912919, 676, 677, 680, 'food_3.jpg'),
       (752, '莫里斯按', '', 589, 11912919, 676, 678, 0, 'food_4.jpg'),
       (753, '三鹿好奶粉', '', 859, 11912919, 676, 679, 0, 'food_5.jpg'),
       (754, '儿童牛奶', '', 5896, 11912919, 676, 679, 0, 'food_6.jpg'),
       (755, '软沙发', '', 8596, 11912919, 628, 696, 0, 'food_b1.jpg'),
       (756, '收纳盒', '', 5966, 11912919, 628, 696, 0, 'food_b2.jpg'),
       (757, '洗衣液', '', 58, 11912919, 628, 696, 0, 'food_r.jpg'),
       (758, '红短沙发', '', 596, 11912919, 628, 696, 0, 'fre_1.jpg'),
       (759, '新西兰奶粉', '', 5896, 11912919, 676, 679, 0, 'fre_2.jpg'),
       (760, '婴儿车', '', 11000, 11912919, 681, 682, 687, 'fre_3.jpg'),
       (761, '夏款婴儿车', '', 963, 11912919, 681, 682, 688, 'fre_4.jpg'),
       (762, '抗压旅行箱', '', 569, 11912919, 681, 683, 685, 'fre_5.jpg'),
       (763, '透明手提箱', '', 8596, 11912919, 681, 683, 684, 'fre_6.jpg'),
       (764, '婴儿果粉', '', 5896, 11912919, 660, 661, 662, 'milk_1.jpg'),
       (765, '椰子粉', '', 5963, 11912919, 660, 661, 662, 'milk_2.jpg'),
       (766, '坚果蛋糕', '', 200, 11912919, 660, 661, 663, 'milk_3.jpg'),
       (767, '编制手提箱', '', 5896, 11912919, 681, 682, 688, 'milk_4.jpg'),
       (768, '纸箱', '', 5896, 11912919, 681, 682, 687, 'milk_5.jpg'),
       (769, '健胃液', '', 152, 11912919, 676, 679, 0, 'milk_6.jpg'),
       (770, '联想NTC', '', 8596, 11912919, 670, 671, 673, 'milk_7.jpg'),
       (771, '香水1', NULL, 100, 11912919, 548, 654, 655, 'milk_8.jpg'),
       (772, '香水2', NULL, 100, 11912919, 548, 654, 655, 'pro1.jpg'),
       (773, '香水3', NULL, 100, 11912919, 548, 654, 655, 'pro2.jpg'),
       (774, '香水4', NULL, 100, 11912919, 548, 654, 655, 'pro3.jpg'),
       (775, '香水5', NULL, 100, 11912919, 548, 654, 655, 'pro4.jpg'),
       (776, '香水6', NULL, 1, 11912919, 548, 654, 655, 'pro5.jpg');
/*!40000 ALTER TABLE `product`
    ENABLE KEYS */;
UNLOCK TABLES;
